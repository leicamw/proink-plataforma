  ...
  return (
    <>
      <style>{`
        ...
        .hs-scan   { animation: scanLine    3.8s ease-in-out infinite; position: absolute; left: 0; right: 0; }
        .hs-blink  { animation: blinkDot    1.1s ease-in-out infinite; }
        .hs-data   { animation: dataFlicker 2.4s ease-in-out infinite; }
        .hs-bar    { animation: progressBar 4s   ease-out     forwards; }
      `}</style>
      ...
      <div className="relative" style={{ width: 420 }}>
        ...
        {/* Chip — topo */}
        <div
          className="absolute -top-9 left-4 z-20 flex items-center gap-2 px-3 py-1.5 text-[8px] font-bold uppercase tracking-[0.2em]"
          style={{ background: "rgba(0,0,0,0.85)", border: "1px solid rgba(34,197,94,0.3)", color: "rgba(34,197,94,0.85)", backdropFilter: "blur(8px)" }}
        >
          <span className="hs-blink w-1.5 h-1.5 rounded-full bg-[#22c55e]" style={{ boxShadow: "0 0 6px rgba(34,197,94,0.9)" }} />
          Traçado fiel às proporções originais
        </div>

        {/* Chip — lateral direita */}
        <div
          className="hs-data absolute -right-2 top-1/3 z-20 px-2 py-3 text-[7px] font-mono"
          style={{
        ...
        <div
          ...
          style={{
            ...
            boxShadow: "0 0 70px rgba(34,197,94,0.14), 0 0 140px rgba(34,197,94,0.05), inset 0 0 40px rgba(34,197,94,0.03)",
          }}
        >
          {/* Topo — status bar */}
          <div
            className="flex items-center justify-between px-5 py-3"
            style={{ borderBottom: "1px solid rgba(34,197,94,0.1)", background: "rgba(34,197,94,0.04)" }}
          >
            <div className="flex items-center gap-2.5">
              <span className="hs-blink w-2 h-2 rounded-full bg-[#22c55e]" style={{ boxShadow: "0 0 7px rgba(34,197,94,0.9)" }} />
              <span className="text-[10px] font-black uppercase tracking-[0.2em] text-[#22c55e]">Decalque IA</span>
              <span className="text-white/15 text-[10px]">·</span>
              <span className="text-[8px] uppercase tracking-[0.15em] text-white/25">Pro Ink</span>
            </div>
            <div className="flex items-center gap-1.5">
              <span className="hs-blink w-1 h-1 rounded-full bg-[#22c55e]" />
              <span className="hs-data text-[8px] text-[#22c55e]/55 uppercase tracking-[0.15em]">Processando</span>
            </div>
          </div>

          {/* Painéis split: foto ← → decalque */}
          <div className="grid grid-cols-2" style={{ borderBottom: "1px solid rgba(34,197,94,0.08)" }}>

            {/* ESQUERDA — foto de referência */}
            <div className="relative" style={{ borderRight: "1px solid rgba(34,197,94,0.08)" }}>
              <div
                className="flex items-center justify-between px-3 py-1.5"
                style={{ borderBottom: "1px solid rgba(34,197,94,0.06)", background: "rgba(0,0,0,0.35)" }}
              >
                <span className="text-[7px] font-bold uppercase tracking-[0.22em] text-white/22">Referência</span>
                <span className="text-[6px] font-mono text-white/15">JPG</span>
              </div>
              ...
              <div className="relative overflow-hidden" style={{ aspectRatio: "3/4" }}>
                ...
                <div className="absolute inset-0" style={{
                  background: [
                    "radial-gradient(ellipse 55% 45% at 50% 36%, rgba(75,58,44,0.85) 0%, rgba(38,29,21,0.6) 45%, transparent 80%)",
                    "radial-gradient(ellipse 70% 25% at 50% 72%, rgba(22,18,14,0.9) 0%, transparent 70%)",
                    "linear-gradient(175deg, rgba(10,8,6,1) 0%, rgba(14,11,8,1) 100%)",
                  ].join(", "),
                }} />
                {/* Scan lines de foto */}
                <div className="absolute inset-0" style={{
                  backgroundImage: "repeating-linear-gradient(0deg, transparent, transparent 2px, rgba(0,0,0,0.25) 3px)",
                  backgroundSize: "100% 3px",
                }} />
                {/* Olhos sugeridos */}
                <div className="absolute w-1.5 h-0.5 rounded-full bg-white/18" style={{ top: "34%", left: "28%" }} />
                <div className="absolute w-1.5 h-0.5 rounded-full bg-white/18" style={{ top: "34%", right: "28%" }} />
                {/* Nariz */}
                <div className="absolute w-0.5 h-2 bg-white/8 rounded-full" style={{ top: "43%", left: "49%" }} />
                {/* Brackets */}
                <div className="absolute top-2 left-2 w-3 h-3 border-t border-l border-[#22c55e]/30" />
                <div className="absolute bottom-2 right-2 w-3 h-3 border-b border-r border-[#22c55e]/30" />
                <div className="absolute bottom-2 left-0 right-0 text-center">
                  <span className="text-[6px] font-mono text-white/14">foto_ref.jpg</span>
                </div>
              </div>
            </div>

            {/* DIREITA — decalque gerado */}
            <div className="relative overflow-hidden">
              <div
                className="flex items-center justify-between px-3 py-1.5"
                style={{ borderBottom: "1px solid rgba(34,197,94,0.06)", background: "rgba(34,197,94,0.03)" }}
              >
                <span className="text-[7px] font-bold uppercase tracking-[0.22em] text-[#22c55e]/65">Decalque</span>
                <span className="text-[6px] font-mono text-[#22c55e]/30">PNG</span>
              </div>

              <div className="relative overflow-hidden bg-white" style={{ aspectRatio: "3/4" }}>
                {/* SVG stencil — rosto */}
                <svg viewBox="0 0 100 130" fill="none" stroke="black" strokeLinecap="round" strokeLinejoin="round"
                  className="absolute inset-0 w-full h-full"
                  style={{ padding: "6px" }}
                >
                  {/* Cabeça */}
                  <path strokeWidth="1" d="M20 56 Q18 38 25 27 Q33 14 50 12 Q67 14 75 27 Q82 38 80 56 Q79 71 74 83 Q67 95 57 100 Q50 104 43 100 Q33 95 26 83 Q21 71 20 56Z" />
                  {/* Cabelo */}
                  <path strokeWidth="0.8" d="M25 27 Q36 10 50 8 Q64 10 75 27" />
                  <path strokeWidth="0.5" d="M29 20 Q40 5 50 3 Q60 5 71 20" />
                  {/* Orelha esq */}
                  <path strokeWidth="0.7" d="M18 55 Q13 60 13 66 Q13 72 18 75 Q21 76 22 73 Q18 68 18 63 Q18 58 22 54 Q20 51 18 55Z" />
                  {/* Orelha dir */}
                  <path strokeWidth="0.7" d="M82 55 Q87 60 87 66 Q87 72 82 75 Q79 76 78 73 Q82 68 82 63 Q82 58 78 54 Q80 51 82 55Z" />
                  {/* Sobrancelha esq */}
                  <path strokeWidth="1" d="M28 43 Q36 38 44 41" />
                  {/* Sobrancelha dir */}
                  <path strokeWidth="1" d="M56 41 Q64 38 72 43" />
                  {/* Olho esq */}
                  <ellipse strokeWidth="0.9" cx="36" cy="52" rx="7.5" ry="5" />
                  <ellipse strokeWidth="0.5" cx="36" cy="52" rx="3" ry="3" />
                  <circle fill="black" cx="36" cy="52" r="1.5" />
                  {/* Olho dir */}
                  <ellipse strokeWidth="0.9" cx="64" cy="52" rx="7.5" ry="5" />
                  <ellipse strokeWidth="0.5" cx="64" cy="52" rx="3" ry="3" />
                  <circle fill="black" cx="64" cy="52" r="1.5" />
                  {/* Nariz */}
                  <path strokeWidth="0.7" d="M47 58 Q45 68 43 73 Q47 77 50 76 Q53 77 57 73 Q55 68 53 58" />
                  <path strokeWidth="0.6" d="M47 58 Q50 56 53 58" />
                  {/* Boca */}
                  <path strokeWidth="1" d="M37 87 Q45 94 50 92 Q55 94 63 87" />
                  <path strokeWidth="0.7" d="M41 87 Q50 83 59 87" />
                  {/* Pescoço */}
                  <line strokeWidth="0.7" x1="43" y1="101" x2="40" y2="120" />
                  <line strokeWidth="0.7" x1="57" y1="101" x2="60" y2="120" />
                  <path strokeWidth="0.4" strokeDasharray="1.5 1" d="M35 117 Q50 121 65 117" />
                  {/* Queixo */}
                  <path strokeWidth="0.5" strokeDasharray="1.2 0.8" d="M40 98 Q50 104 60 98" />
                  {/* Linha de medição verde */}
                  <line strokeWidth="0.3" stroke="#22c55e" strokeOpacity="0.6" x1="5" y1="10" x2="5" y2="122" />
                  <line strokeWidth="0.3" stroke="#22c55e" strokeOpacity="0.6" x1="3" y1="10" x2="7" y2="10" />
                  <line strokeWidth="0.3" stroke="#22c55e" strokeOpacity="0.6" x1="3" y1="122" x2="7" y2="122" />
                  <line strokeWidth="0.3" stroke="#22c55e" strokeOpacity="0.6" x1="10" y1="2" x2="90" y2="2" />
                  <line strokeWidth="0.3" stroke="#22c55e" strokeOpacity="0.6" x1="10" y1="0.5" x2="10" y2="3.5" />
                  <line strokeWidth="0.3" stroke="#22c55e" strokeOpacity="0.6" x1="90" y1="0.5" x2="90" y2="3.5" />
                </svg>

                {/* Scan line verde animada */}
                <div
                  className="hs-scan h-px pointer-events-none"
                  style={{
                    background: "linear-gradient(90deg, transparent 0%, rgba(34,197,94,0.6) 20%, rgba(34,197,94,1) 50%, rgba(34,197,94,0.6) 80%, transparent 100%)",
                    boxShadow: "0 0 10px rgba(34,197,94,0.9), 0 0 20px rgba(34,197,94,0.4)",
                  }}
                />

                {/* Tint verde sutil */}
                <div className="absolute inset-0 pointer-events-none" style={{ background: "rgba(34,197,94,0.025)" }} />

                {/* Brackets verdes */}
                <div className="absolute top-1.5 left-1.5 w-3.5 h-3.5 border-t-2 border-l-2 border-[#22c55e]" style={{ opacity: 0.7 }} />
                <div className="absolute top-1.5 right-1.5 w-3.5 h-3.5 border-t-2 border-r-2 border-[#22c55e]" style={{ opacity: 0.7 }} />
                <div className="absolute bottom-1.5 left-1.5 w-3.5 h-3.5 border-b-2 border-l-2 border-[#22c55e]" style={{ opacity: 0.7 }} />
                <div className="absolute bottom-1.5 right-1.5 w-3.5 h-3.5 border-b-2 border-r-2 border-[#22c55e]" style={{ opacity: 0.7 }} />
              </div>
            </div>
          </div>

          {/* Linha de estilos */}
          <div className="flex items-center gap-1.5 px-4 py-2.5" style={{ borderBottom: "1px solid rgba(34,197,94,0.07)" }}>
            {[
              ...
              <div
                key={s.name}
                className="flex-none px-2.5 py-1 text-[7px] font-black uppercase tracking-[0.18em]"
                style={{
                  background: s.active ? "rgba(34,197,94,0.12)" : "rgba(255,255,255,0.03)",
                  border: s.active ? "1px solid rgba(34,197,94,0.55)" : "1px solid rgba(255,255,255,0.06)",
                  color: s.active ? "#22c55e" : "rgba(255,255,255,0.22)",
                }}
              >
                {s.name}
              </div>
            ))}
            <span className="ml-auto text-[7px] text-white/18 font-mono">4 estilos</span>
          </div>

          {/* Barra de progresso e stats */}
          <div className="px-4 py-3" style={{ background: "rgba(34,197,94,0.02)" }}>
            <div className="flex items-center justify-between mb-1.5">
              <span className="text-[7px] font-mono text-white/20 uppercase tracking-[0.15em]">gerando estilo espectro</span>
              <span className="hs-data text-[7px] font-mono text-[#22c55e]/45">78%</span>
            </div>
            <div className="w-full h-px rounded-full overflow-hidden" style={{ background: "rgba(255,255,255,0.06)" }}>
              <div
                className="hs-bar h-full rounded-full"
                style={{ background: "linear-gradient(90deg, #15803d, #22c55e)", boxShadow: "0 0 6px rgba(34,197,94,0.6)" }}
              />
            </div>
            <div className="flex items-center justify-between mt-1.5">
              <span className="text-[6px] font-mono text-white/14">RES 1024×1536 · DPI 300 · PNG</span>
              <span className="text-[6px] font-mono text-white/14">~12s restantes</span>
            </div>
          </div>
        </div>

        {/* Brackets externos */}
        <div className="absolute -top-1.5 -left-1.5 w-5 h-5 border-t-2 border-l-2 border-[#22c55e]" style={{ boxShadow: "-2px -2px 8px rgba(34,197,94,0.3)" }} />
        <div className="absolute -top-1.5 -right-1.5 w-5 h-5 border-t-2 border-r-2 border-[#22c55e]" style={{ boxShadow: "2px -2px 8px rgba(34,197,94,0.3)" }} />
        <div className="absolute -bottom-1.5 -left-1.5 w-5 h-5 border-b-2 border-l-2 border-[#22c55e]" style={{ boxShadow: "-2px 2px 8px rgba(34,197,94,0.3)" }} />
        <div className="absolute -bottom-1.5 -right-1.5 w-5 h-5 border-b-2 border-r-2 border-[#22c55e]" style={{ boxShadow: "2px 2px 8px rgba(34,197,94,0.3)" }} />

        {/* Chip — base */}
        <div
          className="absolute -bottom-9 right-4 z-20 flex items-center gap-2 px-3 py-1.5 text-[7px] font-semibold uppercase tracking-[0.15em]"
          style={{ background: "rgba(0,0,0,0.85)", border: "1px solid rgba(34,197,94,0.18)", color: "rgba(255,255,255,0.28)", backdropFilter: "blur(8px)" }}
        >
          <span className="text-[#22c55e]/50">✓</span>
          Alta resolução · Pronto para impressão
        </div>
  ...
  return (
    <div className="bg-[#0a0a0a] text-white overflow-x-hidden">
      ...
      <section id="inicio" className="relative min-h-screen flex flex-col overflow-hidden pt-16">
        ...
        {/* Hero layout — text left, tech visual right */}
        <div className="flex-1 max-w-[1400px] mx-auto px-6 md:px-10 w-full flex items-center justify-between gap-10 py-12">

          {/* Text block */}
          <div className="relative z-10 max-w-[560px] w-full flex-shrink-0">
          ...
          {/* ── TECH VISUAL — direita ── */}
          <div className="hidden xl:flex flex-1 items-center justify-end relative z-10 py-8">
            <HeroDecalVisual />
          </div>
